...
// =============== 3. REQUIREMENTS ===============
async function seedRequirements(categories: Database["public"]["Tables"]["contract_categories"]["Row"][]) {
    ...
    const REQUIREMENTS: Database["public"]["Tables"]["contract_requirements"]["Insert"][] = [
        {
            ...
            detailed_instructions: "Certificatul fiscal se obține de la primărie și este valabil 30 de zile."
        },
        {
            ...
            detailed_instructions: "Vânzătorul trebuie să scoată mașina de la fisc înainte de tranzacție."
        }
    ];
